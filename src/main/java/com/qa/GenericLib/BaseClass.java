...
import com.qa.objRepo.LogOutFromApp;
import com.qa.objRepo.LoginPage;
...
public class BaseClass {
	...
	@AfterMethod
	public void callGetTest(ITestResult result) {
		getTest(result);
	}
...
//		d.close();
	...
	public void configBM() {
		WebDriverCommLibs wait=new WebDriverCommLibs();
...
//		LogOutFromApp logout=PageFactory.initElements(d, LogOutFromApp.class);
//		logout.logout();
//	}
	@AfterClass
